    ...
    apTry("Analyzing shapesanity failed", () => {
        if (shape.layers.length === 1) {
            ...
            if (parts[0]) {
                ...
                if (parts[1]) {
                    //Aa??
                    if (parts[0].subShape === parts[1].subShape) {
                        //AaA?
                        if (parts[2]) {
                            //AaA???
                            if (parts[3]) {
                                //AaA?????
                                if (parts[0].subShape === parts[2].subShape) {
                                    //AaA?A???
                                    if (parts[0].subShape === parts[3].subShape) {
                                        //AaA?A?A?
                                        if (parts[0].color === parts[1].color) {
                                            //AaAaA?A?
                                            if (parts[0].color === parts[2].color) {
                                                //AaAaAaA?
                                                if (parts[0].color === parts[3].color) {
                                                    //AaAaAaAa
                                                    checkLocation(
                                                        "Checked",
                                                        false,
                                                        "Shapesanity " +
                                                            colorNames[parts[0].color] +
                                                            " " +
                                                ...
                                                } else if (parts[2].color === parts[3].color) {
                                                    //AaAaAbAb
                                                    checkLocation(
                                                        "Checked",
                                                        false,
                                                        "Shapesanity Half-Half " + ordered(parts[0], parts[2])
                                                    );
                                                } else {
                                                    //AaAaAbAc
                                                    checkLocation(
                                            ...
                                            if (parts[0].color === parts[2].color) {
                                                ...
                                                } else if (parts[1].color === parts[3].color) {
                                                    //AaAbAaAb
                                                    checkLocation(
                                                        "Checked",
                                                        false,
                                                        "Shapesanity Checkered " + ordered(parts[0], parts[1])
                                                    );
                                                } else {
                                                    //AaAbAaAc
                                                    checkLocation(
                                                        "Checked",
                                                        false,
                                                        "Shapesanity Cornered 2-1-1 " +
                                                            toShort(parts[0]) +
                                                            " " +
                                                            ordered(parts[1], parts[3])
                                                    );
                                                }
                                            } else if (parts[1].color === parts[2].color) {
                                                //AaAbAbA?
                                                if (parts[0].color === parts[3].color) {
                                                    //AaAbAbAa
                                                    checkLocation(
                                                        "Checked",
                                                        false,
                                                        "Shapesanity Half-Half " + ordered(parts[0], parts[1])
                                                    );
                                                } else if (parts[1].color === parts[3].color) {
                                                    //AaAbAbAb
                                                    checkLocation(
                                                ...
                                                if (parts[0].color !== parts[3].color) {
                                                    //AaAbAcA!(a)
                                                    if (parts[1].color !== parts[3].color) {
                                                        //AaAbAcA!(a|b)
                                                        if (parts[2].color !== parts[3].color) {
                                                            //AaAbAcAd
                                                            checkLocation(
                                                                "Checked",
                                                                false,
                                    ...
                                    } else if (parts[2].subShape === parts[3].subShape) {
                                        //AaA?B?B?
                                        if (parts[0].color === parts[1].color) {
                                            //AaAaB?B?
                                            if (parts[2].color === parts[3].color) {
                                ...
                                if (parts[0].subShape === parts[2].subShape) {
                                    ...
                                    if (parts[0].color === parts[1].color) {
                                        ...
                                        checkLocation(
                                            "Checked",
                                            false,
                                            "Shapesanity Singles " + ordered(parts[0], parts[1], parts[2])
                                        );
                                    }
                                }
                            }
                            ...
                            if (parts[3]) {
                                ...
                                if (parts[0].color === parts[1].color) {
                                    ...
                                    if (parts[0].subShape === parts[3].subShape) {
                                        ...
                                        checkLocation(
                                            "Checked",
                                            false,
                                            "Shapesanity Singles " + ordered(parts[0], parts[1], parts[3])
                                        );
                                    }
                                }
                            } else {
                                ...
                                if (parts[0].color === parts[1].color) {
                                    ...
                                    checkLocation(
                                        "Checked",
                                        false,
                                        "Shapesanity Adjacent Singles " + ordered(parts[0], parts[1])
                                    );
                                }
                            }
                        }
                        ...
                        if (parts[0].color === parts[1].color) {
                            ...
                            if (parts[2]) {
                                ...
                                if (parts[0].color === parts[2].color) {
                                    ...
                                    if (parts[0].subShape === parts[2].subShape) {
                                        ...
                                        if (parts[3]) {
                                            ...
                                            } else if (isSame(parts[1], parts[3])) {
                                                //AaBaAaBa
                                                checkLocation(
                                                    "Checked",
                                                    false,
                                    ...
                                    } else if (parts[1].subShape === parts[2].subShape) {
                                        //AaBaBa
                                        if (parts[3]) {
                                            //AaBaBa??
                                            if (isSame(parts[0], parts[3])) {
                                        ...
                                        if (parts[3]) {
                                            ...
                                            if (parts[0].color === parts[3].color) {
                                                ...
                                                if (parts[0].subShape !== parts[3].subShape) {
                                                    //AaBaCa!(A)a
                                                    if (parts[1].subShape !== parts[3].subShape) {
                                                        //AaBaCa!(A|B)a
                                                        if (parts[2].subShape !== parts[3].subShape) {
                                                            //AaBaCaDa
                                                            checkLocation(
                                                                "Checked",
                                                                false,
                                    ...
                                    if (parts[3]) {
                                        ...
                                        } else if (isSame(parts[2], parts[3])) {
                                            //AaBaXbXb
                                            checkLocation(
                                                "Checked",
                                                false,
                                ...
                                if (parts[3]) {
                                    ...
                                    if (parts[0].color === parts[3].color) {
                                        ...
                                        } else if (parts[1].subShape === parts[3].subShape) {
                                            //AaBa--Ba
                                            checkLocation(
                                                "Checked",
                                                false,
                            ...
                            if (parts[2]) {
                                ...
                                } else if (isSame(parts[1], parts[2])) {
                                    //AaBbBb
                                    if (parts[3]) {
                                        //AaBbBb??
                                        if (isSame(parts[0], parts[3])) {
                                ...
                                if (parts[3]) {
                                    ...
                                    if (parts[0].subShape === parts[3].subShape) {
                                        ...
                                        checkLocation(
                                            "Checked",
                                            false,
                                            "Shapesanity Singles " + ordered(parts[0], parts[2], parts[3])
                                        );
                                    }
                                } else {
                                    //Aa--Ab--
                                    checkLocation(
                                        "Checked",
                                        false,
                                        "Shapesanity Cornered Singles " + ordered(parts[0], parts[2])
                                    );
                                }
                            }
                        } else {
                        ...
                        if (parts[3]) {
                            ...
                            if (isSame(parts[0], parts[3])) {
                                ...
                                checkLocation(
                                    "Checked",
                                    false,
                                    "Shapesanity Adjacent Singles " + ordered(parts[0], parts[3])
                                );
                            }
                        } else {
                            //Aa------
                ...
                if (parts[1]) {
                    ...
                    if (parts[2]) {
                        //--Aa??
                        if (parts[1].subShape === parts[2].subShape) {
                            //--AaA?
                            if (parts[1].color === parts[2].color) {
                                //--AaAa
                                if (parts[3]) {
                                    //--AaAa??
                                ...
                                if (parts[3]) {
                                    ...
                                    if (parts[1].subShape === parts[3].subShape) {
                                        ...
                                        checkLocation(
                                            "Checked",
                                            false,
                                            "Shapesanity Singles " + ordered(parts[1], parts[2], parts[3])
                                        );
                                    }
                                } else {
                                    //--AaAb--
                                    checkLocation(
                                        "Checked",
                                        false,
                                        "Shapesanity Adjacent Singles " + ordered(parts[1], parts[2])
                                    );
                                }
                            }
                        } else {
                        ...
                        if (parts[3]) {
                            ...
                            if (isSame(parts[1], parts[3])) {
                                ...
                                checkLocation(
                                    "Checked",
                                    false,
                                    "Shapesanity Cornered Singles " + ordered(parts[1], parts[3])
                                );
                            }
                        } else {
                            //--Aa----
                    ...
                    if (parts[2]) {
                        ...
                        if (parts[3]) {
                            //----Aa??
                            if (isSame(parts[2], parts[3])) {
                                //----AaAa
                                checkLocation(
                                    "Checked",
                                    false,
                                    "Shapesanity Half " +
                                        colorNames[parts[2].color] +
                                        " " +
                                ...
                                checkLocation(
                                    "Checked",
                                    false,
                                    "Shapesanity Adjacent Singles " + ordered(parts[2], parts[3])
                                );
                            }
                        } else {
                            //----Aa--
