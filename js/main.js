...
export const logger = createLogger("BlastSlimey/shapezipelago");
...
class ModImpl extends Mod {
    ...
    onGameStarted(root) {
        ...
        logger.debug("I need to restructure these signals.gameStarted things...");
        ...
        logger.debug("Creating shapesanity button");
        ...
        game_menu.trackClicks(shapesanityButton, () => root.hud.parts["ingame_HUD_Shapesanity"].show());
